...
class ControllerCatalogNews extends Controller {
	...
	public function index() {
		...
		$data['add'] = $this->url->link('catalog/news/insert', '&user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				...
				'edit' 				=> $this->url->link('catalog/news/edit', 'news_id=' . $news['news_id'] . '&user_token=' . $this->session->data['user_token'] . $url, true)
			);
		}
	...
	protected function form() {
		...
		if (isset($this->request->get['news_id'])) {
			$data['action'] = $this->url->link('catalog/news/edit', '&news_id=' . $this->request->get['news_id'] . '&user_token=' . $this->session->data['user_token'], true);
		} else {
			$data['action'] = $this->url->link('catalog/news/insert', '&user_token=' . $this->session->data['user_token'], true);
		}
		...
		if (isset($this->request->post['news_description'])) {
			...
			$data['news_description'] = $this->model_catalog_news->getNewsDescription($this->request->get['news_id']);
		} else {
