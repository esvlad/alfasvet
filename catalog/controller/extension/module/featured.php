...
class ControllerExtensionModuleFeatured extends Controller {
			...
			foreach ($products as $product_id) {
				...
				if ($product_info) {
					...
					$data['products'][] = array(
						...
						'tax'         => $tax,
						'rating'      => $rating,
						'hit'		  => $this->model_catalog_product->getProductHit($product_info['product_id']),
	...
	public function chemodan() {
		...
		$setting = $this->model_catalog_product->getSettingChemodan();
		...
		if ($data['products']) {
			return $this->load->view('extension/module/chemodan', $data);
		}
	}
}